            ...
            <div className="footer__content">
              ...
              <ul className="footer__social">
                <li className="footer__social-item">
                  <a href="/words" className="footer__social-link">
                    <svg
                      width="24"
                      height="24"
                      viewBox="0 0 24 24"
                    ...
                    >
                      <g clipPath="url(/wordsclip0_52_211)">
                        <path
                ...
                <li className="footer__social-item">
                  <a href="/words" className="footer__social-link">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(/wordsclip0_52_215)">
                        <path
                ...
                <li className="footer__social-item">
                  <a href="/words" className="footer__social-link">
                    <svg
                      ...
                      xmlns="http://www.w3.org/2000/svg"
                    >
                      <g clipPath="url(/wordsclip0_52_219)">
                        <path
          ...
          <div className="footer__links">
            <ul className="footer__list">
              ...
              <li className="footer__list-item">
                <a href="/words" className="footer__list-link">
                  Kún sózi
                </a>
              </li>
              <li className="footer__list-item">
